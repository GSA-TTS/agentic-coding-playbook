...
All validation and generation tools live in the `scripts/playbook_validator/` Python package (548 tests).
...
├── scripts/
│   ├── playbook_validator/          # Python validation package (548 tests)

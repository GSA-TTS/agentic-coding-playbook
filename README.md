...
All validation and generation tools live in the `scripts/playbook_validator/` Python package (409 tests).
...
├── scripts/
│   ├── playbook_validator/          # Python validation package (409 tests)

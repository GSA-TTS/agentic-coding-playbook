...
All validation and generation tools live in the `scripts/playbook_validator/` Python package (560 tests).
...
├── scripts/
│   ├── playbook_validator/          # Python validation package (560 tests)

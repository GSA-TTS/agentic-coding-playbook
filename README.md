...
All validation and generation tools live in the `scripts/playbook_validator/` Python package (555 tests).
...
├── scripts/
│   ├── playbook_validator/          # Python validation package (555 tests)

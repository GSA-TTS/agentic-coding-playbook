...
All validation and generation tools live in the `scripts/playbook_validator/` Python package. (Live counts — tests, documents, controls, landscape entries — are in the generated [Current State](docs/ROADMAP.md#current-state) table.)
...
├── scripts/
│   ├── playbook_validator/          # Python validation & generation package

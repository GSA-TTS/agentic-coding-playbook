...
description: >
  ...
  to find relevant federal AI guidance across all policy documents. Use when a user
...
3. Read the guidance location referenced
...
3. If not found, read `INDEX.yaml` to get the current document inventory,
   ...
   - Tier 1 documents (core guidance and controls)

...
| LLM08: Vector and Embedding Weaknesses | Not in MVP scope | Address in future multi-agent playbook |
...
| Insecure Inter-Agent Communication | Not in MVP scope | Address in future multi-agent playbook |

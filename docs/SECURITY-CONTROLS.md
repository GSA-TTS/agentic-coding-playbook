...
A control overlay selects, supplements, and refines a baseline set of controls for a specific technology context. This overlay addresses the question: *What additional or modified implementation guidance is needed when an AI coding agent operates within a FIPS Moderate system?*
...
2. **Locate the control** in the tables below to find agent-specific implementation guidance
